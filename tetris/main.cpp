...
int main()
{
    int game[20][10],colortable[20][10], i,n,holdswitch=0, nextblock,gamemode, currentblockposx[4],currentblockposy[4],randblock=0,doweneednextblock=1,x,y,movingblockdown=0,makeblockstationary=0,wait=1, usuwanielini,obrot, endgame=0, lastchance, color, score=-1, lines=0, hold;
    char ch;
    float czas;
    for(i=0;i<20;i++)
    {
